    ...
    dataStore: {
      handler: function handler(newVal, oldVal) {
        ...
        for (var i = 0, len = newVal.length; i < len; i++) {
          ...
          //例如日期值为数组，对数组的转化处理，
          //特此说明
          var newVlaue = JSON.stringify(newVal[i].defaultValue);
          var oldVlaue = JSON.stringify(oldVal[i].defaultValue);
...
var main_component = normalizeComponent(
  ...
  mainvue_type_template_id_770a4db1_render,
  staticRenderFns,
  false,
  null,
  null,
